...
urlpatterns = [
    ...
    path(
        "", views.clean_search_interface, name="public_search"
    ),  # Public search as default
    path(
        "public/enhanced/",
        views.public_enhanced_search_interface,
        name="public_enhanced_search",
    ),
    ...
    path(
        "search/<str:username>/enhanced/",
        views.public_user_enhanced_search_interface,
        name="public_user_enhanced_search",
    ),
    ...
    path(
        "edit-transcript/<str:job_id>/", views.edit_transcript, name="edit_transcript"
    ),
    path(
        "transcript-editor/<str:job_id>/",
        views.transcript_editor_view,
    ...
    path(
        "api/public/enhanced-search/",
        views.api_public_enhanced_search,
        name="api_public_enhanced_search",
    ),
    path(
        "api/public/rag-qa/",
        views.api_public_rag_question_answer,
        name="api_public_rag_qa",
    ),
    # PUBLIC USER-SPECIFIC SEARCH APIs (No authentication required, searches specific user's videos)
    path(
        "api/search/<str:username>/",
        views.api_public_user_search,
        name="api_public_user_search",
    ),
    path(
        "api/search/<str:username>/enhanced/",
        views.api_public_user_enhanced_search,
        name="api_public_user_enhanced_search",
    ),
    path(
        "api/search/<str:username>/rag-qa/",
        views.api_public_user_rag_qa,
        name="api_public_user_rag_qa",
    ),
    # PRIVATE SEARCH APIs (Authentication required)
    path(
        "search/", views.search_videos, name="search_videos"
    ...
    path(
        "api/enhanced-status/",
        views.api_enhanced_transcription_status,
        name="api_enhanced_status",
    ),
    path(
        "api/rebuild-enhanced-index/",
        views.api_rebuild_enhanced_index,
        name="api_rebuild_enhanced_index",
    ),
    # Video serving and info (Public access to video content)
    path("video/<str:video_id>/", views.serve_video_file, name="serve_video"),
    path(
        "api/video-info/<uuid:video_id>/", views.api_video_info, name="api_video_info"
    ),
    ...
    path(
        ...
        views.api_rebuild_search_index,
    ...
    path(
        "api/timestamp-content/<uuid:job_id>/",
        views.api_timestamp_content,
        name="api_timestamp_content",
    ),
    ...
    path(
        ...
        views.api_ai_enhanced_search,
        name="api_ai_enhanced_search",
    ),
    path(
        "api/ai-question-answer/",
        views.api_ai_question_answer,
        name="api_ai_question_answer",
    ),
