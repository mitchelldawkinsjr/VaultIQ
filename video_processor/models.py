...
class VideoJob(models.Model):
    ...
    youtube_url = models.URLField(null=True, blank=True, help_text="Original YouTube URL if this was a YouTube video")
    ...
    def is_youtube_video(self):
        ...
        if re.search(youtube_id_pattern, filename):
            ...
            if any(pattern in filename.lower() for pattern in ['[', ']', '_', 'youtube']):
                return True
